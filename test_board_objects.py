...
class Test_board_objects(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ({"P1 ": [[10, 8]], "P2 ": [[11, 8]]}, "P1 ", [4, 4], [
            ...
            ['   ', '   ', '   ', '   ', '   ', '   ', '   ', '   ', '   ',
             '   ', 'P2 ']],
            12, 11, [["P1 ", [10, 8]], ["P2 ", [11, 8]]]),

        ({" P ": [[11, 8]], " B ": [[13, 8]], " L ": [[12, 8]],
            "KN ": [[10, 8]]}, " P ", [4, 4], [
            ['   ', '   ', '   ', '   ', '   ', '   ', '   ', '   ', '   '],
            ['   ', '   ', '   ', '   ', '   ', '   ', '   ', '   ', '   '],
            ['   ', '   ', '   ', '   ', '   ', '   ', '   ', '   ', '   '],
    ...
    def test_get_coords(self, board, piece, piece_index, x, y,
                        replace_x, replace_y, expected):
        board_objects = Board_objects(board)
        self.assertEqual(board_objects.get_coords(piece, piece_index, x, y,
                         replace_x, replace_y), expected)
