...
class test_moves(unittest.TestCase):
    ...
    def test_validate_overlapping(self, turn, piece, new_coords, example_black_coords, example_white_coords):
        ...
        self.assertFalse(self.moves.validate(turn, piece, 0, new_coords, example_black, example_white))
...
# BISHOP
    ...
    def test_bishop_move(self, turn, piece, new_coords, example_black_coords, example_white_coords, piece_index=0):
        example_black = Board_objects(example_black_coords)
        example_white = Board_objects(example_white_coords)
        self.assertTrue(self.moves.validate(turn, piece, piece_index, new_coords, example_black, example_white))
    ...
    def test_bishop_move2(self, turn, piece, new_coords, example_black_coords, example_white_coords, piece_index=0):
        example_black = Board_objects(example_black_coords)
        example_white = Board_objects(example_white_coords)
        self.assertFalse(self.moves.validate(turn, piece, piece_index, new_coords, example_black, example_white))
