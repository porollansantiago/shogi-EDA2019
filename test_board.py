...
class Test_board(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ("black", [4, 8], [3, 6], 12, 10, [[" R ", [11, 8]],
                                           [" B ", [10, 8]]], [], "KN ",
            {"KN ": [[4, 8]], " R ": [[11, 8]], " B ": [[10, 8]]},
            {" P ": [[3, 6]]},
            ['   ', '   ', '   ', '   ', '   ', '   ', '   ', '   ', '   ',
             '   ', ' B ', ' R ', ' P ']),
        ...
        ("white", [4, 0], [3, 2], 10, 14, [], [[" B ", [13, 0]],
                                               [" B ", [11, 0]],
                                               [" P ", [10, 0]],
                                               [" L ", [12, 0]]], "KN ",
            {" R ": [[3, 2]]},
            {"KN ": [[4, 0]], " B ": [[13, 0], [11, 0]], " P ": [[10, 0]],
             " L ": [[12, 0]]},
            ['   ', '   ', '   ', '   ', '   ', '   ', '   ', '   ', '   ',
             '   ', ' P ', ' B ', ' L ', ' B ', ' R ']),
        ("white", [4, 0], [3, 2], 10, 14, [], [[" B ", [13, 0]],
    ...
    def test_capture(self, turn, coords, new_coords, bcaptopx,
        ...
        board.white.captured_x_top, board.black.captured_x_top = (wcaptopx,
                                                                  bcaptopx)
    ...
    def test_play_promote(self, black, white, piece_coords, new_coords,
                          promote, expected, turn):
        board = Board(white, black)
        board.turn = turn
        ...
        self.assertEqual(board.make_board()[new_coords[1]][new_coords[0]],
                         expected)
    ...
    def test_play_checkmate(self, turn, black, white,
    ...
    def test_play_checkmate_false(self, turn, black, white,
                                  piece_coords, new_coords):
        board = Board(white, black)
        board.turn = turn
        board.play(piece_coords[0], piece_coords[1])
    ...
    def test_play_check_move(self, turn, black, white, piece_coords,
                             new_coords, piece2_coords, new_coords2):
        board = Board(white, black)
        board.turn = turn
        board.play(piece_coords[0], piece_coords[1])
        board.play(new_coords[0], new_coords[1])
    ...
    def test_play_check_move_false(self, turn, black, white, piece_coords,
                                   new_coords, piece2_coords, new_coords2):
        board = Board(white, black)
        board.turn = turn
